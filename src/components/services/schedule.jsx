...
function Schedule() {
  ...
  return ( 
    ...
    <Grid id="schedule-delivery-grid" container  style={{ marginBottom:0, height:"fit-content", maxWidth: "1400px", margin: "auto" }}>
      ...
      <Container id="schedule-container" disableGutters style={{padding:30,maxWidth:"90vw"}}>
        ...
        <Grid container  >
            <Grid item xs={12} md={4}>
              ...
              <div id="section-content-cost-effectiveness" className="content ">
