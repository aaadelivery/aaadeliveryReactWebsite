        ...
        >
          <Grid container>
            <Grid item xs={12} md={6} style={{ padding: 30 }}>
              ...
              >
                ...
                <AccordionDetails>
                  <div>
                    ...
                    <div className="leftText">
                      <Markdown
                        content={page["paragraphContent1hidden"]}
                      ></Markdown>
                    </div>
                    <h2>{page["paragraphTitle2hidden"]}</h2>
                    <div className="leftText">
                      <Markdown
                        content={page["paragraphContent2hidden"]}
                      ></Markdown>
                    </div>
                  </div>
                </AccordionDetails>
              ...
              >
                Read {expanded1 ? "Less" : "More"}
              </button>
            </Grid>
            <Grid item xs={12} md={6} style={{ padding: 30 }}>
              <img
                src={page["paragraphImage1"]}
          ...
          <Grid container>
            <Grid item xs={12} md={6} style={{ padding: 30 }}>
              ...
              >
                ...
                <AccordionDetails>
                  <div>
                    ...
                    <div className="leftText">
                      <Markdown
                        content={page["paragraphContent3hidden"]}
                      ></Markdown>
                    </div>
                    <h2>{page["paragraphTitle4hidden"]}</h2>
                    <div className="leftText">
                      <Markdown
                        content={page["paragraphContent4hidden"]}
                      ></Markdown>
                    </div>
                  </div>
                </AccordionDetails>
              ...
              >
                Read {expanded2 ? "Less" : "More"}
              </button>
            </Grid>
            <Grid item xs={12} md={6} style={{ padding: 30 }}>
              <img
                src={page["paragraphImage2"]}
                style={{ width: "80%", margin: "auto" }}
              ></img>
            </Grid>
          </Grid>
                ...
                <>
                  <Grid item xs={12} sm={3}>
                    ...
                    >
                      ...
                      <div className="content ">{member["pgimg"]["job"]}</div>
                    </div>
                  </Grid>
                </>
              );
