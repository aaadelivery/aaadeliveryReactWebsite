...
export default function Animation({steps}){
    ...
    return <>
        <div>
            <div class="works-mob" style={{display:"block"}}>
            <div class="works-mob__item">
                ...
                <div class="works-mob__item-txt">{steps[0].split('|').slice(0,1).join(' ') } <br/>{steps[0].split('|').slice(1).join(' ') }</div>
            ...
            <div class="works-mob__item">
                <svg width="68" height="68" viewBox="21 20 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M48.2839 63.336C52.5559 63.336 55.6759 60.144 55.6759 54.6C55.6759 49.056 52.5559 45.864 48.2839 45.864C43.9879 45.864 40.8679 49.056 40.8679 54.6C40.8679 60.144 43.9879 63.336 48.2839 63.336ZM48.2839 59.448C46.7479 59.448 45.6439 58.128 45.6439 54.6C45.6439 51.072 46.7479 49.752 48.2839 49.752C49.7959 49.752 50.8999 51.072 50.8999 54.6C50.8999 58.128 49.7959 59.448 48.2839 59.448ZM65.9192 52.92L69.3992 49.176V46.2H57.2552V49.872H63.8792L60.8792 53.112V56.112H62.8712C64.6952 56.112 65.4392 56.736 65.4392 57.744C65.4392 58.872 64.3832 59.496 62.7752 59.496C61.1912 59.496 59.4632 59.016 58.1192 58.104L56.3912 61.68C58.1192 62.76 60.5912 63.336 62.9192 63.336C67.9832 63.336 70.2392 60.6 70.2392 57.744C70.2392 55.344 68.7512 53.52 65.9192 52.92Z" fill="white"></path>
                    <defs>

                    </defs>
                </svg>
                <div class="works-mob__item-txt">{steps[2].split('|').slice(0,1).join(' ') } <br/>{steps[2].split('|').slice(1).join(' ') }</div>
            </div>
            <div class="works-mob__item">
                <svg width="68" height="68" viewBox="21 20 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="55" cy="54" r="38" fill="white"></circle>
