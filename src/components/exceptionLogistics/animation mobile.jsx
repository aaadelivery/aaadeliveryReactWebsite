    ...
    return <>
        <div>
            ...
            <div className="works-mob__item">
                ...
                <div className="works-mob__item-txt">{steps[1].split('|').slice(0,1).join(' ') } <br/>{steps[1].split('|').slice(1).join(' ') }</div>
            ...
            <div className="works-mob__item">
                ...
                <div className="works-mob__item-txt">{steps[2].split('|').slice(0,1).join(' ') } <br/>{steps[2].split('|').slice(1).join(' ') }</div>
            </div>
            <div className="works-mob__item">
                <svg width="68" height="68" viewBox="21 20 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="55" cy="54" r="38" fill="white"></circle>
                ...
                <div className="works-mob__item-txt">{steps[3].split('|').slice(0,1).join(' ') } <br/>{steps[3].split('|').slice(1).join(' ') }</div>
            </div>
