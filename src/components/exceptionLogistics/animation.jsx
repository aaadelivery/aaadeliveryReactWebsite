            ...
            <svg class="works__svg" style={svgStyle} fill="none" xmlns="http://www.w3.org/2000/svg">
                <g transform="translate(31 -66)">
                    ...
                    <g class="point-1 point" data-work-id="1">
                        ...
                        <g class="text">
                            <text class="txt" fill="#263238">
                                <tspan x="-17" y="160">{props.steps[0].split('|').slice(0,1).join(' ') } </tspan>
                    ...
                    <g class="point-2 point" data-work-id="2">
                        ...
                        <g class="text">
                            <text class="txt" fill="#263238">
                                <tspan x="195" y="109">{props.steps[1].split('|').slice(0,1).join(' ') } </tspan>
                    ...
                    <g class="point-3 point" data-work-id="3">
                        ...
                        <g class="text">
                            <text class="txt" fill="#263238">
                                <tspan x="410" y="111">{props.steps[2].split('|').slice(0,1).join(' ') } </tspan>
                    ...
                    <g class="point-4 point" data-work-id="4">
                        ...
                        <g class="text">
                            <text class="txt" fill="#263238">
                                <tspan x="620" y="144">{props.steps[3].split('|').slice(0,1).join(' ') } </tspan>
