...
export function CustomizedSnackbars(props) {
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <a>
          {loading ? (
            ...
            <button
              className="round-button large-circle-button"
              onClick={handleClick}
            >
              Submit
            </button>
        ...
        <ReCAPTCHA sitekey="6LdrCCwqAAAAABzlJy-E1cmBPV0Nnrd61S-ZcN4j" onChange={handleCaptcha} />
      ...
      <Snackbar open={captchaError} autoHideDuration={6000} onClose={handleClose}>
        <Alert onClose={handleClose} severity="error" sx={{ width: "100%" }}>
          Solve the captcha before submitting the form
        </Alert>
      </Snackbar>
    ...
    >
      <div id="specialist-form">
        <input
          ...
          value={firstName}
          onChange={(evt) => updateValue(setFirstName, evt.target.value)}
        ></input>
