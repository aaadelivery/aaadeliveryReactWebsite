  ...
  return (
    <div className="container">
      <div className="content">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 712.19 453.8">
          <g id="Layer_2" data-name="Layer 2">
            <g id="Layer_1-2" data-name="Layer 1">
              <UsaState
                d="M471.85,161.2l-.4,11,1.9,9.5v10.4l1.3,10.3-.1.2s-.9,3,.7,4.5l.2.2.1.3c.2.9,1.2,5.7-.9,7.3-.7,2.7-1.7,5.9-3.3,6.7l-.4,3.6,6.2-1.2,2.8,1.7,1.3.5c.8-1.5,2.1-3.6,3.9-3.6,1.3,0,2.3,1,3.1,2.9h.1c.2,0,.3,0,.4-.1.3-.2.5-1.1.1-2.9l-.1-.6,4.6-4v3.2l2.7.2v-2.6l6-6,.7-5h.9c1.5,0,4.9-.5,5.7-1.8a1.58,1.58,0,0,0-.1-1.5l-.1-.3-.7-7.1-1.3-9.4-.6-10.3-1.3-8.5-1.7-6.3.4-4.5-4.9-.6-4.4.7h-5.3a43,43,0,0,1-7.1.7h-.4C476.75,165.7,473.55,163.9,471.85,161.2Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
              ...
              ></UsaState>
              <UsaState
                d="M593.35,182.9h0l-4.8-.6-2,3.3H584l-3,4.3-3.5.3-.5-8-12.9,1.7-2.2-9.6-.2.7-.1,9.7-.1.2a48.45,48.45,0,0,1-5.4,7.5l-.8.8-.8-.8a5.06,5.06,0,0,0-.9-.8v.5l-.4.4c-2.6,2.4-1.9,3.5-1.9,3.5l.2.3v.1c.8,2.3.8,3.7-.1,4.4a1.9,1.9,0,0,1-1.3.5,3,3,0,0,1-1.2-.3h-.1l-.3-.2h0c-.9-1.1-1.3-1.1-1.3-1.1-.3.3-.7,3.1-.3,6.6l.1.9-1.9.5a3.4,3.4,0,0,1-1.6,2.6,3.81,3.81,0,0,1-1.9.4h-.1v3.4l3,1.5v2.6c1.5,1.9,4.1,4.8,5.5,5.1l.5.1.2.4s2,3.7,5.4,4.3c1-.9,3-2.7,4.7-2.7a1.7,1.7,0,0,1,.7.1,2.34,2.34,0,0,1,1.5,1.6c.1,0,.3.1.4.1a.6.6,0,0,0,.4-.1c.5-.2,1.4-1,2-4l.2-.9.9.1h.4c1,0,3.6-.2,4.8-1.7l.2-.2.3-.1s.9-.4.1-2.5c-.4-1.2-.9-2.5.1-3.1a.9.9,0,0,1,.5-.1h.1l1.5-5.3,2.4-4.5c-.1-3.3.4-5.1,1.7-5.5.1,0,.3-.1.4-.1,1,0,1.9.9,3.1,3.1H584l1-7.3h2.7v-1.6l2.1-1.4c.3-1.9.9-4.1,2.1-4.6.1,0,.2-.1.3-.1l.9-4.2Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M594,181.3c-.6.2-1.8.8-2,1.4-.1.1-.1.2,0,.4l.3.7.5.1h0l.6.2.4.1h0l6.3,1.9.2-1.4-.3-1.8C597.65,182.1,595,181.2,594,181.3Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M402.55,112c1.6.6,5.6,2.2,7,4.7,1,.4,3.6,1.6,4.3,4l7.6,5.2,1,7c1.9,2.3,2.5,4,2,5.3a2.31,2.31,0,0,1-1.2,1.2l-.7,3.4,2.7,2.6q3.45.6,4.5,2.4v.1l9.3-.3,8.3-.4,8.8-.5,10.6-.4v-1.1c-3.5-4.9,0-15.5,0-15.5-3.1-4.9,6.2-28.3,6.2-28.3-8.8,14.7-11,13.3-11,13.3-1.4-.8.4-5.5,2.7-10.4l-4.1-3.5-.9-8.3c-2.6-.3-4.1-1-4.7-2.2a3.81,3.81,0,0,1-.3-1l-8.5-1.2-2.8-1.5-2.7-.5-7.3-1.7a5,5,0,0,1-4.2-2.9,26.39,26.39,0,0,1-5.3,0c3.5-5.7,1.3-5.4,1.3-5.4-6.5,3.7-10.7,5-13.4,5.3l-4.5,9.3-.7-.1h-.1a5.44,5.44,0,0,0-3.6,1.4,8.08,8.08,0,0,0-2.4,5.5,4.4,4.4,0,0,1,2.7,1.9c.7,1.2.6,2.7-.3,4.4C402.55,106,402,110,402.55,112Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M264.65,104.8l-.1,1.1c-.6,8-1.6,20.3-2.6,32.2l57.9,3.4h11.4l5.1,4.5-.1.5h.3a9.76,9.76,0,0,0,3.7-1.2l.3-.1h.3a12.25,12.25,0,0,0,1.9.2,3.28,3.28,0,0,0,1.8-.3l.6-1.2,1,.9s3.4,3.1,5.8,3.2h.4l.3.2a11,11,0,0,1,1.1,1h0l.1-.5c.7-2.3,1.7-6.5,1.6-8.1-.9-.6-2.8-2.3-2.1-6.3l.2-.9h1.9V103.5c-1.8-1.2-5.3-3.8-4.9-6.2.2-1.2,1.2-2.1,3-2.6V94L267,90.3C266.25,95.5,264.75,104.1,264.65,104.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M269,63.1c-.4,3.8-.8,7-.8,7.6v.9c-.1,3.1-.8,12.7-1.1,16.8l86.8,3.7a7.79,7.79,0,0,0-.5-7.5,6.78,6.78,0,0,0-.6-.9l-.3-.4.3-.2a.35.35,0,0,0-.1-.2c-1.9-4-1.9-11.9-1.9-12.2.4-7.6-.9-9-.9-9-2.2-1.5-2.2-9.9-2.1-13.3v-.1l.1-.3v-.1a5.88,5.88,0,0,0,.5-3.6c-20.8-.8-50.4-3.3-77.3-5.8C271.25,42.1,270.35,50.6,269,63.1Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M380.05,246.3l-1.3-36.6a6.18,6.18,0,0,1-3.7-2.5,8.15,8.15,0,0,1-.9-5.6l.1-.2c1.2-2.2,1.1-3,1.1-3.2h-.2c-.2,0-.5.1-.7.1a5.84,5.84,0,0,1-1.8.2,5.66,5.66,0,0,1-4.8-2.5l-85.1-2.2c-.6,6.6-1.2,13-1,15.2,1,5.8-1.3,29.2-1.9,34.7Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M257.05,172.5c.6-7.2,4.8-59,5.5-66.9l-82.3-10-1.1,8.7h.2L169.15,162C207.25,167,250.65,172.4,257.05,172.5Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M455.05,246c.2-.9.1-1.4-.1-1.6h0a5,5,0,0,1-1.6.3,3.29,3.29,0,0,1-1.9-.6c-2.2-1.5-2.2-5.2-2.2-5.6V238l.4-.3c.7-.6-.2-3.5-2-6.5l-4.1-.5-7.4-7.6.3-.7a17.76,17.76,0,0,0,2.1-9.9h-7.3l.3-1.3c.7-3.3,0-4.3-.2-4.6a.62.62,0,0,0-.4-.2h-.4l-.3-.3-6.6-6.4c-3.1-1.6-3.5-5.9-3.5-6.4v-.2a33.64,33.64,0,0,0,0-6.4,16.53,16.53,0,0,1-2.9-3l-51,1.7a17.85,17.85,0,0,0,1,2.6l.7-.1.1,1,1.6,5.5a3.55,3.55,0,0,0,3.2,1.8,4.87,4.87,0,0,0,1.2-.1,7,7,0,0,1,1.3-.2,2.48,2.48,0,0,1,1.8.7c.9,1,.7,2.7-.7,5.3a5.47,5.47,0,0,0,.6,3.9,4.8,4.8,0,0,0,3.1,1.8l.8.1,1.3,39h.1l-.1.5v1h-.1l-.7,6,60.9-1.6.2.1a3.33,3.33,0,0,1,2,2.5c.2,1.2-.4,2.4-1.6,3.7l-1,2,5.8-.3a12,12,0,0,0,2.5-8.6l-.2-1.2h2.1l-.1-2.2h2.7Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <polygon
                points="579.05 181.9 579.45 187.9 579.85 187.9 582.85 183.5 585.35 183.5 587.35 180.4 583.55 181.3 579.05 181.9"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></polygon>
              <UsaState
                d="M579.05,181.9l17.6-3.9,6,1.8s-20.3,1.6-22.5,4.1"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M591.05,180.5a2.51,2.51,0,0,1,.4-.7,2.34,2.34,0,0,1,.7-.7l-4,1Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M638.05,84.3h.7l.1.9a17,17,0,0,1,0,6.1c.6,2.4,1.5,4.1,1.9,4.3l1.2.4-.5,1.1a2.9,2.9,0,0,0-.2,2.1,2.61,2.61,0,0,0,1.8,1l.7.1,3.1,11.4,5.6-1.2v-3.1l1-3.3-1.1-1.7,1.2-10.5V82.8l.4-.3c1.3-1.1,3.8-3.8,3.7-5.7a1.62,1.62,0,0,0-.7-1.4l-.3-.2-.2-1.1L637.05,78h-.3A24,24,0,0,0,638.05,84.3Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M96.45,131.6h0c-3.7-.8-18.6-4.1-35.3-8.1l-12.5,49.8,53.4,79.7c.6-2.1,1.6-6.5,3.6-15.9l.4-1.8,1.4,1.2c2.6,2.4,5.1,3.9,5.9,3.9h0s.4-.8-1.1-4.6l-.1-.3,20.5-95.9C115,135.9,97.75,132,96.45,131.6Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M526.25,271.7l-.1,1-17.7,2,9.8,34.7,3.2,6.2v2h.3a1.66,1.66,0,0,1,1.2.5c1.1,1.1.1,3.2-1.1,5.2-.3,2.7-.5,6.9.4,7.9l.2.3.1,4.7h0a18.24,18.24,0,0,0,1.9,5.1l2.8,3.1,39.4-2v3.2h.8l.3-2.8c-.9-1-2.2-2.7-1.5-4.1q.6-1.2,2.7-1.2a4.87,4.87,0,0,1,1.2.1l7.7-.1a13.88,13.88,0,0,1,.8-5.8,45,45,0,0,1,4.8-14.6l.1-.1h-7.7l.3-1.3c.9-4.1-1.4-6.1-1.9-6.5l-3.4-1.1v-.7a2.2,2.2,0,0,0-.1-.8c-.4-2.5-2.4-5.1-2.9-5.9a10.56,10.56,0,0,1-6.8-6.4,10.76,10.76,0,0,1-5.7-5.1c-3.8-.6-7-5.3-7.1-5.5l-2.5-4.6c-4.4-.8-7-2.2-7.6-4.4a4.9,4.9,0,0,1,.9-3.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M658.65,73.7l.1.4a3.57,3.57,0,0,1,1.2,2.7c0,2.9-2.9,5.9-4.1,7v8.3l-1.1,9.8,1.2,1.9-1.2,4v2.3l14.4-2v-1.3c1.5-3.7,6-4.3,8.8-4.3a13.77,13.77,0,0,0,.6-1.6h-6.1V98.6a2.2,2.2,0,0,1-1.3-.4c-2.3-1.3-2.8-6-2.9-7.5l-3.6-12.4-3.6-11.7c-2.7.6-1.8,6.9-1.8,6.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M206.55,324.8a3,3,0,0,1,2.4-.9,11.18,11.18,0,0,1,3.5.8h0l.2.2h0c1.5,1.3,25.1,2.6,46.3,3.2l6-82.5c-26.5-1.8-72.3-8.6-80.1-9.8l-13.1,98.3,12.9,2,1.7-8.5,20.3,2.4C205.65,327.5,205.55,325.9,206.55,324.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M470.65,331.9l.2-18.5,1.1-19.7V280.2l-1.5-1h-.1v-.1h-27.2l.3,2.3c1.3,2.6,1.1,3.4.4,3.9a1.45,1.45,0,0,1-.7.2c-.7,0-1.3-.6-2.3-1.6a2,2,0,0,0-.9-.7,5.88,5.88,0,0,0-.4,2.4c1.7,2,.6,4.6-.2,5.7l-.5.7-.8-.4a1.6,1.6,0,0,0-.8-.3.6.6,0,0,0-.4.1c-.7.4-1.2,1.8-1.4,3.1a1.76,1.76,0,0,1,.8,1.8c-.2,1.5-2.4,2.5-4.3,3.1-.6,4.5,1.2,10.5,1.2,10.6v6.1l-1.1.1c.5,3.9,1.4,6.8,1.9,7l.5.2,1.8,5.4h-1.9l.4,1.9-.4.4a27.69,27.69,0,0,0-6.3,17.6l26.5-1.3-.2,1.3c-.4,2.4-.7,7.4,1.5,8.1l.4.1,3.3,7a1.24,1.24,0,0,0,.3-.2c3.9-6.8,7-3.5,7-3.5,4.6-2.8,5.2.4,5.2.4l1.6-.2C473.85,355.6,472.05,341,470.65,331.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M685.85,122.8c-3.5-7-5.7-6.1-5.7-6.1-5.4,1.5-1.7-7-1.7-7a6.11,6.11,0,0,1-1.3-5.2c-2.2.1-5,.7-6,2.8v2.5l-17.4,2.4-6.5,1.4-.1,10.6,25.2-5.9.4.5c.6.8,5.6,7.2,8.2,10h.1c2.2-7.4,4.8-1.5,4.8-1.5.7-2.6,7.6-3.3,7.6-3.3l-.7-2.8C686.55,126.3,685.85,122.8,685.85,122.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M710,55.4c-4,3.1-4,.4-4,.4-.9-9.7-7.1-6.6-7.1-6.6l-6.2-22.5-8-4c1.8,2.2-4.4,4.9-4.4,4.9-6.6-.9-2.7-4.4-4.9-3.5s-5.7,15-5.7,15c2.2,4,.4,6.2.4,6.2-2.7,0-2.7,5.3-2.7,5.3,8.4,2.7,4,3.5,4,3.5-5.3,2.2-5.3,13.3-5.3,13.3h-2.7c-.1,0-.1-.1-.2-.1l3.3,10.4,3.7,12.7v.1c.1,2,.8,5.3,1.8,6,.1,0,.2.1.3.1a1.09,1.09,0,0,0,.5-.1l1.5-.8v3.2h4.5a97,97,0,0,0,1.7-11.1,7,7,0,0,0,6.6-2.2c-.4-2.7,4-3.8,4-3.8.9-14.4,4.4-7.3,4.4-7.3,5.7-5.7,7.5-3.5,7.5-3.5l6.6-5.3C715.25,59,710,55.4,710,55.4Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M633.55,180.5a6.7,6.7,0,0,1-2.2-3.5l-2.9-2.6c-.3.5-.6.9-.7,1.1,1.5,5,3.6,12.6,4.2,15.6l9.4-.2-.5-1.5C638,189.3,633.55,180.5,633.55,180.5Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M647,154.4l2.3-6.9-2.7-1.5c-4.6-.7-11.6-3.8-11.9-4l-.7-.3-1.7,5.4-1.1,1.6a3,3,0,0,1,.6,2.3,2.81,2.81,0,0,1-1.3,1.8c-.1.2-.2.6.1,1.5h3.5l-.8,1.5a1.65,1.65,0,0,0,0,1.3,5,5,0,0,0,2.9,2.2,2.73,2.73,0,0,1,2.6,1.5c.5,1.4-.9,2.9-2,3.9-2.5,3.5-3.4,4.3-4,4.4a55,55,0,0,0-4,4.7l2.3,2c6,4.9,10.3,4.7,10.3,4.7l.7,4.6c1.7-.4,2.4-5.9,2.4-5.9,3.7-2.4,4.6-12.6,4.6-12.6l-.9-9.4C642.35,156.6,646.35,154.7,647,154.4Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M648.35,144.1h0v.1l2.2,1.3a29.36,29.36,0,0,1,13.7-8.2c.4.2,1.8-.2,3.4-.8v-.1c.9-3-.8-11.4-1.4-14.3l-19,4.5C647.75,129.4,649.35,139.6,648.35,144.1Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M671.55,120.8l-3.2.8c.6,2.8,2,10,1.6,14,2.1-.8,3.9-1.6,3.9-1.6a10,10,0,0,1,2.2-2.8c.7.5,2.1-.2,3.2-.9C676.85,127.5,672.85,122.4,671.55,120.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M488,359.8l-.3-8.9-3.2-2.2v-4.3l37.6-3.3a24.53,24.53,0,0,1-1.4-4.6l-.1-4.2c-1.5-2.3-.8-8.3-.6-9.4v-.1l.1-.3h0a14.77,14.77,0,0,0,1.3-2.6c-.1,0-.2.1-.4.2l-1.6.9v-4.8l-3.1-6-10-35.2-12.9,1.4-18.2,1.5-2.2.6,1,.6v14.7l-1.1,19.7-.2,18.3c0,.2,3.2,20.9,2.9,28.5h.2V359l4.1-.2c1.7-11.1,5.7-2.2,5.7-2.2.7,1.5-.3,3.8-.6,4.4A11.42,11.42,0,0,1,488,359.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M275.55,244h2.3c.5-4.6,3-28.8,2-34.5-.3-2.8.5-10.6,1.2-18,.6-6.1,1.2-12.4,1.2-14.9l-24.1-2h-.7c-6,0-37.3-3.9-63.3-7.2l-8.8,66.4C194.05,235.1,253.55,244,275.55,244Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M131.75,32.7c1.3,1.1,3.3,3.8,1.5,10,.5,1.4,1.6,3.1,2.8,3.5l.6.1.2.5c.7,2.3,3.1,8.7,5.2,10.1,1,.4,4.1,1.7,4.5,4,.2,1.3-.5,2.6-2.1,3.7-1.6,3.5-4,10-2.9,12.9a2.18,2.18,0,0,0,.5.8c1.3-1.3,3.3-3,5-3a3,3,0,0,1,1,.2c1.4.7,1.6,2.8.8,6.6.6,3.3,2.3,8.6,4.1,9.9h.2a2.66,2.66,0,0,1,1.2.3c1.4.9,2,3.3,1.8,7.5a14.25,14.25,0,0,0,1.1-1.2l.4-.5.7.2a19.9,19.9,0,0,0,4.3.5,19.42,19.42,0,0,0,2.4-.2h.4a9.62,9.62,0,0,1,5,1.4c.9-1.3,2.5-3,4.4-3h.4a3.69,3.69,0,0,1,2.7,2.1l.8-5.9,84.4,10.3c.5-2.9,1.7-10.2,2.1-14.3v-.1c.2-3.3,1-14.3,1.1-17.7v-.8c0-.7.3-3.5.8-7.8.8-7.4,2.3-20.4,2.3-24.7-34.5-3.3-64.1-6.6-64.1-6.6-23.7-3.7-48.3-8.7-70.3-13.6C134.05,21.5,132.55,29.9,131.75,32.7Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M119,224.8l-1.7-.3h-.2l-.4-.1-2.4,11.1c1.5,3.8,1.6,5.9.3,6.8a2.13,2.13,0,0,1-1.2.3c-1.7,0-4.1-1.6-6-3.2-2.3,11.1-3.3,14.9-3.9,16.2.6,4.8,1.7,8.7,2.2,9.1,0,0,2.4,1.3,2.5,3.5.1,1.4-.7,2.8-2.4,4l-.2.1a8.09,8.09,0,0,0-4.7,4.5c.1,1.2.4,5.8-3.1,8.3v4.6h.7c1.5,0,2.1.6,2.3,1.1.6,1.2-.1,2.7-4.7,6.4l-1.7,3,49.2,29.6,26.2,4,13-98.1c-8.7-.8-55-9.3-63.8-10.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M167.75,163.9l-1.1-.1,3.1-17.5c-5.8-.3-20.4-3.1-35.1-6.2l-17.6,82.2,1.7.3c23.2,4.3,58,10.5,64.3,10.9l8.8-66.5C182.55,165.9,174.05,164.7,167.75,163.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M350,48.4c-.1,5.5.4,10.8,1.2,11.4.5.2,2.3,1.8,1.8,10.7,0,2.9.4,8.5,1.7,11.2a7.24,7.24,0,0,1,.9,2.4,10,10,0,0,1,0,9.2v3.1l-.8.2c-1.5.3-2.1.8-2.2,1.1-.1.9,1.9,2.9,4.4,4.4l.5.3v31.1l17.2.2,29.5-1.5h16.1l-.7-5.2-7.5-5-.1-.4c-.4-2-3.4-3-3.5-3l-.5-.1-.2-.5c-.7-1.7-4.3-3.5-6.4-4.1l-.4-.1-.2-.4c-1.5-2.9-.1-9.3.1-10l.1-.2c.4-.8.8-1.9.4-2.6a2.75,2.75,0,0,0-2-1l-1-.1.1-1c.2-3.5,1.3-6.2,3.3-7.9a7.49,7.49,0,0,1,4.5-1.8l3.5-7.1c-1.9-.3-2.1-1.3-1.5-.9,1.3.9,11.9-10.2,11.9-10.2-1.3-5.3,17.2-13.2,17.2-13.2-6.6-4-9.7,0-9.7,0-3.5-.4-4-3.1-4-3.1-3.1,3.5-8.8,3.1-8.8,3.1-2.7-4.4-8.8-4.4-8.8-4.4a14.38,14.38,0,0,0-10.6-4.4c-4,5.8-6.6,0-6.6,0-10.6.4-10.6-4-10.6-4,.4-9.3-4.4-8.8-4.4-8.8v8c-3.5.9-11.9,1.1-23.1.7A9.28,9.28,0,0,1,350,48.4Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M242.75,429.9s-2.1-5.1,1.5-1.8a45.68,45.68,0,0,0,5.4,1.8,10.88,10.88,0,0,0,3.3,1.9s1.9.3,3,5.5a5.09,5.09,0,0,0,3.2,1.7,6.49,6.49,0,0,1-4.1,3.6s-4.1,1.8-4.4.8c0,0-4.5,3.4-4.1,5,0,0-2.1,2.2-4.5-.7,0,0-.6-4.1,0-4.7,0,0-1.5-6.5-2.7-6.7v-2s2.9-1,3.5-2.9Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M232.85,421a16.29,16.29,0,0,0,5.2-1s4.8-2.8,0-2.8c0,0,1.1-2.3-5.2-1.8,0,0-2.3-1.5-2.3-1.9,0,0-2.2-.4-1.9,1,0,0-.2,1.9.8,2.2C229.45,416.8,232.85,419.4,232.85,421Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M224.75,418.6s1.8-.5,1.8-1.3c0,0-.2-1.5-.9-1.6h-3.1a2.89,2.89,0,0,1,.9,1.6S223.45,418.2,224.75,418.6Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M219.35,410.5s2.8.9,4.2,0c0,0,4.5-.9,4.4.4,0,0,.6,1.8-3.4,2.6,0,0,.1-1.1-4.5-1.1C220.05,412.4,217.55,411.3,219.35,410.5Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M212.55,408c.5-.4,0,1.3,0,1.3-1.3.8-3.4,0-3.4,0,.8-1.4-1.1-.8-1.1-.8-1.1.3-3.2-.6-3.2-.6-1.3-.6-1.3-3.3-1.3-3.3-.3-2.2,4-2.8,4-2.8,2.4.2,2.3,4.1,2.3,4.1S211.35,408.8,212.55,408Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M185.65,395.8s.5,3-2.4,3c0,0-4.1-1.4-4.7-2.3,0,0,.3-3.5,2.7-3.3h2.5S187,393,185.65,395.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ></UsaState>
              <UsaState
                d="M173.35,398.8s-2.1,2-2.5,1.7l-.5-.3s.5-2.4,1.5-2.5c0,0,2-1.4,2.3-.6A3.74,3.74,0,0,1,173.35,398.8Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
              ...
              ></UsaState>
              <UsaState
                d="M666.25,140.7c-.4,2.4-9.4,5.4-9.4,5.4-4.8-.4-5.4,2-5.4,2a17.24,17.24,0,0,1-1.8,1.6l-1.6,4.7c11.7-.9,21.2-13.2,21.2-13.2Z"
                stroke="blue"
                fill="white"
                isMounted={isMounted}
                hasTransitionedIn={hasTransitionedIn}
  ...
  return (
    <>
      <path
        ...
        stroke="#367bdc"
        fill="#367bdc"
        style={{ transition: tran }}
        className={`card ${props.hasTransitionedIn && "in"} ${
          props.isMounted && "visible"
        }`}
      ></path>
    </>
  );
